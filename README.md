...
### Prerequisites
```bash
# Install ROS2 (Ubuntu 22.04 - Humble/jazzy)
sudo apt update
...
```
#### GUI
<img width="1029" height="951" alt="Screenshot from 2026-01-13 21-22-10" src="https://github.com/user-attachments/assets/da185a40-8f40-42b6-8a44-c9f0be6ada8f" /><img width="1029" height="951" alt="Screenshot from 2026-01-13 21-22-28" src="https://github.com/user-attachments/assets/4e6e9804-263c-47bd-be1c-ea93f893f130" />
